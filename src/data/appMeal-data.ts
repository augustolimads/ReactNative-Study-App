export interface appMealCategoryProps {
  id: string;
  title: string;
  color: string;
}

export interface appMealDataProps {
  id: string;
  categoryIds: string[];
  title: string;
...
export const appMealCategoryData: appMealCategoryProps[] = [
  ...
  category("c9", "cakes", "#675346"),
  category("c10", "Brazilian", "#41d178"),
];
